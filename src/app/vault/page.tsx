...
const MOCK_ARTIFACTS: VaultCardData[] = [
  {
    ...
    displayName: 'SCADA-CTL-FW-v3.2.1',
    description: 'PLC firmware binary for industrial control system.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    vaultId: '1234-56789-0123',
    displayName: 'UAV-FLIGHT-CFG-2026.01',
    description: 'Autonomous drone flight controller configuration manifest.',
    status: 'ACTIVE',
  ...
  },
  {
    ...
    vaultId: '1234-56789-0123',
    displayName: 'K8S-DEPLOY-MANIFEST-v1.0',
    status: 'EXPIRED',
